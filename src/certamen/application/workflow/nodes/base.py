...
from certamen_core.domain.workflow import BaseNode as DomainBaseNode
from certamen_core.domain.workflow import (
    ExecutionContext,
    NodeProperty,
    Port,
    PortType,
)
from certamen_core.shared.constants import MAX_MULTI_INPUTS
