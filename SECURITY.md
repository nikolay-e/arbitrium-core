...
The Certamen Framework team takes security seriously. We appreciate your efforts to responsibly disclose your findings.
...
1. Go to the [Security tab](https://github.com/nikolay-e/certamen-core/security)
...
**NEVER commit API keys to version control.** Certamen Framework supports multiple secure methods for managing secrets:
...
Certamen Framework uses `pip-audit` and `safety` in CI/CD to scan for known vulnerabilities. To check your installation:
...
Certamen Framework is **not designed** for:
...
Certamen Framework is designed for:
...
- **GitHub Watch:** Click "Watch" → "Releases only" on [our repo](https://github.com/nikolay-e/certamen-core)
- **Security Advisories:** [GitHub Security Advisories](https://github.com/nikolay-e/certamen-core/security/advisories)

## Questions?

For security-related questions (not vulnerabilities), please:

- Open a [GitHub Discussion](https://github.com/nikolay-e/certamen-core/discussions) (preferred)
- Or file a regular [GitHub Issue](https://github.com/nikolay-e/certamen-core/issues) with the `security-question` label

For general questions, use [GitHub Discussions](https://github.com/nikolay-e/certamen-core/discussions).
